...
export const gataivai: Village = {
  ...
  malaeFono: [
    { title: "Salemuliʻaga", details: ["Nuuli"] },
  ],

  maotaOAlii: [
    { title: "Le Tunofo ma Malaetuli", details: [] },
  ],
  ...
  aualumaOTane: ["Sa Vaovasa"],

  saotamaitai: [
    { title: "Le Laʻulu", details: ["Samalaʻulu"] },
    { title: "Maposua", details: ["Punipuao"] },
    { title: "Naʻi", details: ["Seupuʻe"] },
    { title: "Toilolo", details: ["Lauagaia"] },
  ],

  ipuATamaitai: [
    { title: "Samalaʻulu", details: ["Mala avaga"] },
    { title: "Lauagaia", details: ["Folofolo i luga"] },
  ],
};
