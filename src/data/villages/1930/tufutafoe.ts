...
export const tufutafoe: Village = {
  version: "1930",
  name: "Tufutafoe",
  ...
  tulou: [
    ...
    "Susū mai ia o Seuʻula",
    "Alaala mai le nofo matua tala o Tuaautoʻa",
    "Afifio mai Tuifaigā ma Aiolupotea",
    "Afio mai lau Afioga a Tonumaipeʻa",
  ],
  ...
  ipuATamaitai: [
    { title: "Tilomai", details: ["Lepa i neneʻa"] },
  ],
};
