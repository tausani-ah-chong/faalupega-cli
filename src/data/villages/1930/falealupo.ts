...
export const falealupo: Village = {
  ...
  igoaIpu: [
    { title: "Solia", details: ["Aiga le mimisa"] },
    { title: "Foaʻimea", details: ["Samoa ua tasi"] },
    { title: "Seumanutafa", details: ["Taua ma lupe vao"] },
    { title: "Auvaa", details: ["Agataoto"] },
    { title: "Lamositele", details: ["Fesilafaʻi"] },
    { title: "Aʻeʻau", details: ["Tautali fua"] },
  ],

  aualumaOTane: ["Sa Toleafoā"],

  saotamaitai: [
    { title: "Auvaa", details: ["Soimavi"] },
    { title: "Sā Seumanutafā", details: ["ʻApaʻula"] },
    { title: "Aʻeʻau", details: ["Iliganoa"] },
    { title: "Solia", details: ["Tilomai"] },
    { title: "Foaʻimea", details: ["Tilomai"] },
    { title: "Lamositele", details: ["Tilomai"] },
  ],
