...
export const faala: Village = {
  ...
  malaeFono: [
    { title: "Vailoa", details: ["O le Malae tausi e Tumua ma Pule"] },
    { title: "Niupulusū", details: ["Soaseū"] },
  ...
  igoaIpu: [
    { title: "Leituala", details: ["Nuu lelei ua matagofie"] },
    { title: "Leavai", details: ["Fai malo ma Pule"] },
    { title: "Momo", details: ["Samoa ua tasi"] },
    { title: "Niupulusū", details: ["Moeonā"] },
    { title: "Tualau", details: ["Malaga ma Tumua amia mai le ipu"] },
    { title: "Leleisiʻuao", details: ["Tuaoi ua tau"] },
    { title: "Salu", details: ["Fetalaiga feaveaʻi"] },
    { title: "Iʻaulualo", details: ["Tuaoi le tau au mai taua tuumalo"] },
  ],
  ...
  saotamaitai: [
    ...
    { title: "Iʻaulualo", details: ["ʻAifimālie"] },
  ],
